...
<head>
    ...
    <title>Forgot Password - FitNova</title>
    <!-- Fonts -->
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .back-link { margin-top: 20px; font-size: 0.9rem; color: var(--text-light); }
...
<body>
    ...
    <div class="container" id="forgotContainer">
        ...
        <form id="forgotForm">
            ...
            <button type="submit" class="btn-reset" id="submitBtn">Send Reset Link</button>
        </form>
    ...
    <div class="container success-message" id="successBlock">
        ...
        <h2>Request Sent!</h2>
        <p class="subtitle">If an account exists, you will receive instructions shortly.</p>
