...
<head>
    ...
    <title>Cardio Blast - FitNova</title>
    ...
    <style>
        ...
        .workout-image { 
            width: 100%; 
            height: 450px; 
            background-image: url('https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?auto=format&fit=crop&q=80&w=1200'); 
    ...
    <div class="container">
        <div class="workout-header">
            ...
            <div class="workout-meta">
                ...
                <div class="meta-item"><i class="fas fa-fire"></i> <strong>350+ kcal burned</strong></div>
                <div class="meta-item"><i class="fas fa-dumbbell"></i> <strong>Jump Rope (Optional)</strong></div>
        ...
        <div class="workout-content">
            ...
            <p>High-energy cardio session designed to improve cardiovascular health and burn maximum calories.</p>

            <h2>Exercises</h2>
            <ul class="exercise-list">
                <li>
                    <strong>1. Jump Rope / Mock Rope</strong>
                    3 mins<br>
                    Steady bounce to get rhythm.
                </li>
                <li>
                    <strong>2. Boxing Jacks</strong>
                    45 seconds<br>
                    Jumping jacks with a punch.
                </li>
                <li>
                    <strong>3. Skaters</strong>
                    45 seconds<br>
                    Side to side plyometric movement.
                </li>
                <li>
                    <strong>4. Running in Place</strong>
                    60 seconds<br>
                    High knees for intensity.
                </li>
                <li>
                    <strong>5. Butt Kicks</strong>
                    60 seconds<br>
                    Dynamic hamstring stretch/cardio.
                </li>
            </ul>
