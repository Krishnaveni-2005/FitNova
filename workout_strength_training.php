...
<head>
    ...
    <title>Strength Training 101 - FitNova</title>
    ...
    <style>
        ...
        .workout-image { 
            width: 100%; 
            height: 450px; 
            background-image: url('https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?auto=format&fit=crop&q=80&w=1200'); 
        ...
        <div class="workout-header">
            <div class="workout-image">
                <div class="workout-title-overlay">
                    <h1>Strength Training 101</h1>
                    <p>Build a Strong Foundation</p>
                </div>
            </div>
            <div class="workout-meta">
                <div class="meta-item"><i class="far fa-clock"></i> <strong>45 minutes</strong></div>
                <div class="meta-item"><i class="fas fa-fire"></i> <strong>250 kcal burned</strong></div>
                <div class="meta-item"><i class="fas fa-dumbbell"></i> <strong>Barbell / Dumbbells</strong></div>
                <div class="meta-item"><i class="fas fa-signal"></i> <strong>Beginner</strong></div>
            </div>
        </div>

        <div class="workout-content">
            <h2>About This Workout</h2>
            <p>Master the compound movements that are essential for building overall body strength and muscle mass. Focus on controlled movements and proper form.</p>

            <h2>Exercises</h2>
            <ul class="exercise-list">
                <li>
                    <strong>1. Goblet Squats</strong>
                    3 sets x 10-12 reps<br>
                    Hold weight at chest. Sit back and down, keeping chest up.
                </li>
                <li>
                    <strong>2. Pushups / Chest Press</strong>
                    3 sets x 10-12 reps<br>
                    Engage chest and triceps. Keep core tight.
                </li>
                <li>
                    <strong>3. Bent Over Rows</strong>
                    3 sets x 10-12 reps<br>
                    Hinge at hips, pull weight to hip crease. Squeeze back.
                </li>
                <li>
                    <strong>4. Overhead Press</strong>
                    3 sets x 10-12 reps<br>
                    Press weight vertically without arching back.
                </li>
                <li>
                    <strong>5. Romanian Deadlift</strong>
                    3 sets x 10-12 reps<br>
                    Hinge at hips, slight knee bend. Feel hamstring stretch.
                </li>
            </ul>
