...
<head>
    ...
    <title>Pilates Core Flow - FitNova</title>
    ...
    <style>
        ...
        .workout-image { 
            width: 100%; 
            height: 450px; 
            background-image: url('https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?auto=format&fit=crop&q=80&w=1200'); 
...
<body>
    ...
    <div class="container">
        <div class="workout-header">
            <div class="workout-image">
                <div class="workout-title-overlay">
                    <h1>Pilates Core Flow</h1>
                    <p>Control and Precision</p>
                </div>
            </div>
            <div class="workout-meta">
                <div class="meta-item"><i class="far fa-clock"></i> <strong>30 minutes</strong></div>
                <div class="meta-item"><i class="fas fa-fire"></i> <strong>150 kcal burned</strong></div>
                <div class="meta-item"><i class="fas fa-dumbbell"></i> <strong>Mat</strong></div>
        ...
        <div class="workout-content">
            ...
            <p>Low-impact exercises emphasizing core strength, posture, balance, and flexibility.</p>

            <h2>Exercises</h2>
            <ul class="exercise-list">
                <li>
                    <strong>1. The Hundred</strong>
                    100 pumps<br>
                    Legs lifted, pump arms vigorously.
                </li>
                <li>
                    <strong>2. Roll Ups</strong>
                    8-10 reps<br>
                    Articulate spine vertebrae by vertebrae.
                </li>
                <li>
                    <strong>3. Single Leg Circles</strong>
                    8 reps (each direction)<br>
                    Stable pelvis, mobile hip.
                </li>
                <li>
                    <strong>4. Rolling Like a Ball</strong>
                    8-10 reps<br>
                    Massage the spine, find balance.
                </li>
                <li>
                    <strong>5. Spine Stretch</strong>
                    8-10 reps<br>
                    Sit tall, reach forward over imaginary ball.
                </li>
            </ul>
