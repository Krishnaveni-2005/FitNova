...
<head>
    ...
    <title>Upper Body Power - FitNova</title>
    ...
    <style>
        ...
        .workout-image { 
            width: 100%; 
            height: 450px; 
            background-image: url('https://images.unsplash.com/photo-1574680096145-d05b474e2155?auto=format&fit=crop&q=80&w=1200'); 
...
<body>
    ...
    <div class="container">
        <div class="workout-header">
            <div class="workout-image">
                <div class="workout-title-overlay">
                    ...
                    <p>Define Your Arms and Torso</p>
                </div>
            </div>
            <div class="workout-meta">
                <div class="meta-item"><i class="far fa-clock"></i> <strong>40 minutes</strong></div>
                <div class="meta-item"><i class="fas fa-fire"></i> <strong>200 kcal burned</strong></div>
                <div class="meta-item"><i class="fas fa-dumbbell"></i> <strong>Dumbbells</strong></div>
        ...
        <div class="workout-content">
            ...
            <p>Target chest, back, shoulders, and arms with this comprehensive upper body resistance routine.</p>

            <h2>Exercises</h2>
            <ul class="exercise-list">
                <li>
                    <strong>1. Dumbbell Chest Press</strong>
                    3 sets x 12 reps<br>
                    Press weights up over chest.
                </li>
                <li>
                    <strong>2. Single Arm Row</strong>
                    3 sets x 12 reps (each)<br>
                    Pull weight to hip, engage lat.
                </li>
                <li>
                    <strong>3. Lateral Raises</strong>
                    3 sets x 15 reps<br>
                    Lift weights to side to shoulder height.
                </li>
                <li>
                    <strong>4. Bicep Curls</strong>
                    3 sets x 12 reps<br>
                    Curl weight with control.
                </li>
                <li>
                    <strong>5. Tricep Extensions</strong>
                    3 sets x 12 reps<br>
                    Extend arm overhead or kickback.
                </li>
            </ul>
