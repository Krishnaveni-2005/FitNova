...
<head>
    ...
    <title>Functional Fitness - FitNova</title>
    ...
    <style>
        ...
        .workout-image { 
            width: 100%; 
            height: 450px; 
            background-image: url('https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&q=80&w=1200'); 
...
<body>
    <div class="container">
        <div class="workout-header">
            <div class="workout-image">
                <div class="workout-title-overlay">
                    ...
                    <p>Move Better in Daily Life</p>
                </div>
            </div>
            <div class="workout-meta">
                <div class="meta-item"><i class="far fa-clock"></i> <strong>35 minutes</strong></div>
                <div class="meta-item"><i class="fas fa-fire"></i> <strong>220 kcal burned</strong></div>
                <div class="meta-item"><i class="fas fa-dumbbell"></i> <strong>Kettlebell / Dumbbell</strong></div>
        ...
        <div class="workout-content">
            ...
            <p>Exercises designed to train your muscles to work together and prepare them for daily tasks by simulating common movements.</p>

            <h2>Exercises</h2>
            <ul class="exercise-list">
                <li>
                    <strong>1. Kettlebell Swings</strong>
                    3 sets x 15 reps<br>
                    Hinge movement driven by hips.
                </li>
                <li>
                    <strong>2. Farmer's Walk</strong>
                    3 sets x 60 seconds<br>
                    Walk carrying weights. Core stability.
                </li>
                <li>
                    <strong>3. Step Ups</strong>
                    3 sets x 12 reps (each leg)<br>
                    Step up onto a box or chair.
                </li>
                <li>
                    <strong>4. Woodchoppers</strong>
                    3 sets x 12 reps (each side)<br>
                    Rotational core movement.
                </li>
                <li>
                    <strong>5. Bear Crawl</strong>
