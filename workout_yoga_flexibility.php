...
<head>
    ...
    <title>Yoga for Flexibility - FitNova</title>
    ...
    <style>
        ...
        .workout-image { 
            width: 100%; 
            height: 450px; 
            background-image: url('https://images.unsplash.com/photo-1549576490-b0b4831ef60a?auto=format&fit=crop&q=80&w=1200'); 
        ...
        <div class="workout-header">
            <div class="workout-image">
                <div class="workout-title-overlay">
                    <h1>Yoga for Flexibility</h1>
                    <p>Restore, Relax, and Lengthen</p>
                </div>
            </div>
            <div class="workout-meta">
                <div class="meta-item"><i class="far fa-clock"></i> <strong>30 minutes</strong></div>
                <div class="meta-item"><i class="fas fa-fire"></i> <strong>100 kcal burned</strong></div>
                <div class="meta-item"><i class="fas fa-dumbbell"></i> <strong>Yoga Mat</strong></div>
                <div class="meta-item"><i class="fas fa-signal"></i> <strong>All Levels</strong></div>
            </div>
        </div>

        <div class="workout-content">
            <h2>About This Workout</h2>
            <p>A gentle flow focused on opening up tight areas like hips, hamstrings, and shoulders. Perfect for recovery days or stress relief.</p>

            <h2>Exercises</h2>
            <ul class="exercise-list">
                <li>
                    <strong>1. Downward Facing Dog</strong>
                    Hold for 5-8 breaths<br>
                    Lengthen spine and pedal out the feet.
                </li>
                <li>
                    <strong>2. Warrior II</strong>
                    Hold for 5 breaths (each side)<br>
                    Open hips and strengthen legs. Gaze over front hand.
                </li>
                <li>
                    <strong>3. Triangle Pose</strong>
                    Hold for 5 breaths (each side)<br>
                    Side body stretch and hamstring opener.
                </li>
                <li>
                    <strong>4. Pigeon Pose</strong>
                    Hold for 10 breaths (each side)<br>
                    Deep hip opener. Relax into the stretch.
                </li>
                <li>
                    <strong>5. Child's Pose</strong>
                    Hold for 10 breaths<br>
                    Resting pose to lengthen the back and relax.
                </li>
            </ul>
