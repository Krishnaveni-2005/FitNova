...
<head>
    ...
    <title>Lower Body Sculpt - FitNova</title>
    ...
    <style>
        ...
        .workout-image { 
            width: 100%; 
            height: 450px; 
            background-image: url('https://images.unsplash.com/photo-1518611012118-696072aa579a?auto=format&fit=crop&q=80&w=1200'); 
...
<body>
    ...
    <div class="container">
        <div class="workout-header">
            <div class="workout-image">
                <div class="workout-title-overlay">
                    <h1>Lower Body Sculpt</h1>
                    <p>Strong Legs and Glutes</p>
                </div>
            </div>
            <div class="workout-meta">
                ...
                <div class="meta-item"><i class="fas fa-dumbbell"></i> <strong>Dumbbells (Optional)</strong></div>
        ...
        <div class="workout-content">
            ...
            <p>A leg-focused workout to build strength and tone in the quads, hamstrings, and glutes.</p>

            <h2>Exercises</h2>
            <ul class="exercise-list">
                <li>
                    <strong>1. Weighted Squats</strong>
                    3 sets x 12 reps<br>
                    Keep weight in heels.
                </li>
                <li>
                    <strong>2. Walking Lunges</strong>
                    3 sets x 12 reps (each leg)<br>
                    Step forward, drop back knee.
                </li>
                <li>
                    <strong>3. Glute Bridges</strong>
                    3 sets x 20 reps<br>
                    Squeeze glutes at the top.
                </li>
                <li>
                    <strong>4. Calf Raises</strong>
                    3 sets x 20 reps<br>
                    Lift heels as high as possible.
                </li>
                <li>
                    <strong>5. Sumo Squats</strong>
                    3 sets x 12 reps<br>
                    Wide stance to target inner thighs.
                </li>
            </ul>
